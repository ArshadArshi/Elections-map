...
const JKAssemblyMap: React.FC<Props> = ({ height, width, zoom }) => {
  ...
  const styleFeature = (feature?: Feature<Geometry, GeoJsonProperties>) => {
    ...
    let fillColor;
    if (loksabha === "Baramulla") {
      fillColor = "#FF9900";
    } else if (loksabha === "Srinagar") {
      fillColor = "#4DB6E2";
    } else if (loksabha === "Jammu") {
      fillColor = "#006400";
    } else if (loksabha === "Udhampur") {
        fillColor = "pink";
      } else if (loksabha === "Anantnag-Rajouri") {
        fillColor = "yellow";
      } 
    else {
      fillColor = "#808080";
